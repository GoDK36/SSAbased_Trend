...
pol_data = pd.read_csv(r'G:\Programming\python\NLP\DecoSentA\SSAbasedTrend\1-SO-SSAbasedTrend-InputSample.t.csv', names=['date','pol'])[1:]
...
# print(pol_graph)
# ##csv파일로 출력
# pol_df.to_csv(r'G:\Programming\python\NLP\DecoSentA\SSAbasedTrend\result.csv')

# os.startfile(r'G:\Programming\python\NLP\DecoSentA\SSAbasedTrend\result.csv')